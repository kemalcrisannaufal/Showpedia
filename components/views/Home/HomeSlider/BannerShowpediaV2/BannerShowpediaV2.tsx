  ...
  return (
    <div
      className={cn(
        ...
        "w-full flex flex-col md:flex-row-reverse items-center justify-center gap-5 md:gap-10 relative p-5 md:p-10 overflow-hidden rounded-xl"
      )}
    >
      <div
      ...
      <div className="text-white">
        ...
        <Button
          classname="font-medium mt-3 text-sm md:text-md"
          onClick={() => push("/shows")}
        >
          Start Exploring
        </Button>
